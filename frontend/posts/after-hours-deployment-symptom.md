...
or System Dynamics Archetype](/posts/e2m-st-addiction)), my team has been the intervenor to the company when it comes to
...
Post a maintenance window and make the changes after hours (i.e., use the DevOps team to deploy after hours as the
...
large push and took months of effort to get everyone on board and figure out all of the nuances of implementing the
...
correlated with the database schema changing. I can suppose about the root causes of the issues for eternity (and I
...
Since this after-hours deployment strategy has seemed effective at decreasing the amount of service degradation
...
siloed DevOps teams (Skelton & Pais, 2016), siloed DevOps teams present the "Shift the Burden" Systems Dynamics
...
hiding a larger systemic issue in the overall technological organization processes, how software is being designed,
