...
description: >
  Second report with changes that I have made since the first post.
...
challenging week in November, I found myself in a reinforcement loop that was amplifying the
...
in this section. The daily reminder in the form of a comment is helpful to set 
up my perspective through a lens of gratitude first thing in the morning.

<!-->Set intention!<-->
I have also added a specific "subsection" for intention, which is less task-oriented 
(since I have the Today's Plan section) and more how I want to approach
the day. As an example, the following was yesterday's intention.
...
intention in the morning allows me to avoid the fear of not being productive (one of my big triggers
...
support with no need for all of the other bells and whistles of a full-on project management
application.
...
opinionated and customized to have a task management application already created. Since I was not
...
expanded note types and how Tasks would fit in. 
...
Notes_ for capturing fleeting thoughts throughout the day. They may or may not be valuable
...
projects/programs that include sub-projects. If a project gets too large, the main project document
...
Management program and how the processes in physical engineering relate back to software
engineering. To make the project more manageable, I want to approach it systematically by breaking
it down into a collection of smaller projects that deliver a series of posts that I write as I
take the classes. 

Overall, this new approach to task and project management has required very little overhead and has been
working out quite well with my zettelkasten approach to note-taking. There are some pain points which
...
> others are sequential markdown files coupled on a specific class. The Project Note type needs to be
> expanded with a standardized definition and could be codified into a template. <br/><br/>
> Using the ZK system that I am already using for daily notes and zettels, I can expand this to also
...
> **Backlog Task:** A Daily Task that is not high enough priority to plan for that day.<br/><br/>
