...
This was no more obvious than in one of my friendships. I have a friend who seems to almost refuse
...
nothing further on the topic. This would explain some of the events growing up where I would
truthfully answer the question of what I wanted to eat with "I do not have a preference" and answer
the follow-up suggestion with an affirmation. Decisions on what to wear and what to eat take some of
...
I am curious about how best to replenish this energy and how to limit the expenditures of it in
the first place. I need to do more research on replenishing the decision-making energy to satisfy
the curiosity of replenishing, but I have an idea on how to start minimizing the depletion.
...
these decisions. The lack of decision-making energy has a direct impact on the individual's lives,
...
Individuals will get frustrated for not making the desired progress on life goals.
