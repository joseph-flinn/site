...
of me to help shape the DevOps practices and direction at the organization. I felt like I was
...
was my primary guide and I kept a pulse on the State of DevOps reports after the publication of that
book. 
...
is used, it is based on an individual's prior experience which is vastly different than others'
...
the job and then help educate and change the structure. I knowingly took on the task of a culture
paradigm shift.
...
not onboard. My belief in MinimumCD as the holistic solution to both value delivery and improved
...
area of growth and improvement). In my departure, this misalignment still exists, which does not bode
...
(owning books means that I possess the knowledge even if I have yet to read them). The dangerous part
...
The self-awareness that knowledge and expertise do not equate to value is the root of my
...
my self-awareness, who I am as a human, how I see the world, and how I see the humans around me.
