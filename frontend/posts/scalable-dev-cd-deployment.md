...
There are some cases where installable software keeps itself up-to-date outside of the OS-provided update paths or
...
restarts every time, makes users upset.
...
can be pushed out to users on demand, bugs can have a very short lifespan in Production, and overall feedback loops decrease substantially leading to more stable software.
