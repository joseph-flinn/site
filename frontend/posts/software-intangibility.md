...
description: >
  Reminiscing of simpler days where wood was the medium of choice rather than bits and bytes.
...
out to be my favorite pastime). 

Suits of armor made of cardboard sat in the corner ready to be donned at a moment's notice. Shields
...
positive space was explored in scrollwork pieces.
...
working on, something that lives in silicon, rarely manifesting into the material world. Yes, there
...
racing along highways etched into silicon. 
...
Instead, lots of boxes and lines are drawn on a whiteboard, showing how data flows through the
...
working on is extremely challenging. Instead of building a silicon-based system with code, I have
...
the silicon highways, for a chance to jump out along the fiber lines and go for an adventure.
...
avoid getting lost in cyberspace. The smell of fresh-cut pine and the silkiness of sawdust is an
