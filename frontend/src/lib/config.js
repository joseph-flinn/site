...
export const aiValues = "I identify as a writer and I believe that writing is at the center of critical thinking (read more [here](/posts/learning-through-writing)). In this age of LLMs and generative AI, style and voice has become my most important value in writing. Style and voice can only be created or found through the grit and repetition of actually doing the writing. As such, I do not use LLM-generated content for prose, especially on this blog.\n\nI, however, do use LLMs for some parts of this blog. I lean on LLM technology to do the bulk of the code generation. The approach that I take will be covered in a later blog post. I also do use LLMs to proofread a blog post, but have strong boundaries around it only making suggestions for changes for typos and to point out where sentences do not flow (but not to give suggestions for what the changes should be). The decision to manually make that change is fully under my control, and I make the actual change so that if there is a grammatical issue that I need to fix, I am the one fixing it and I learn what I need to do and how to think in the future. This workflow will be the subject of a future blog post."
